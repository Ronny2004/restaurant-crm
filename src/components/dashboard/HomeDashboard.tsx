...
import { ChefHat, UtensilsCrossed, Monitor, Calculator, LogOut, Megaphone, UserCircle, Settings, User } from "lucide-react";
import type { AppProfile } from "@/types/auth";


export default function Home({ profile }: { profile: AppProfile }) {
  ...
  const roles = [
    ...
    },
    {
      ...
      desc: "Formularios, enlaces, QR y análisis",
      color: "#a855f7"
    }
  ];
